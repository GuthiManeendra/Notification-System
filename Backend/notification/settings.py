...
ALLOWED_HOSTS = ['*']  # Render handles routing; restrict to your domain later if needed
...
# CORS Configuration for Frontend (Vercel + Localhost)
CORS_ALLOW_ALL_ORIGINS = True  # Allows full access for development and API testing
...
# Notification & Third-Party API Configurations
...
# 3. OneSignal Push Notification Configuration
